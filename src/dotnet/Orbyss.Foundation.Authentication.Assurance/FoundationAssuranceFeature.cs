...
[ShellFeature(
    name: "Orbyss.Foundation.Authentication.Assurance",
    DisplayName = "Orbyss Foundation Authentication Assurance",
    Description = "Authorizes named step-up policies using standard acr, amr, and auth_time claims.")]
public sealed class FoundationAssuranceFeature(ShellSettings settings) : IShellFeature
{
    /// <inheritdoc />

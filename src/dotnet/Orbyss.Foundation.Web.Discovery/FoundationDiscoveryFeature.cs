...
[ShellFeature(
    name: "Orbyss.Foundation.Web.Discovery",
    DisplayName = "Orbyss Foundation Web Discovery",
    Description = "Serves an explicit public HTML, sitemap, robots and optional Markdown projection.")]
public sealed class FoundationDiscoveryFeature(ShellSettings settings) : IWebShellFeature
{
    /// <inheritdoc />

...
{
    var settings = new ShellSettings(new ShellId("probe"), ["Orbyss.Foundation.Authentication.ClientCredentials"]);
    ...
    new FoundationClientCredentialsFeature(settings).ConfigureServices(services);

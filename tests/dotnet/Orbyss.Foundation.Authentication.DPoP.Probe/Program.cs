...
var feature = services.GetRequiredService<FoundationDPoPFeature>();
...
var nonceFeature = nonceServices.GetRequiredService<FoundationDPoPFeature>();
...
{
    var settings = new ShellSettings(new ShellId("probe"), ["Orbyss.Foundation.Authentication.DPoP"]);
    ...
    var feature = new FoundationDPoPFeature(settings);
...
static RequestDelegate BuildPipeline(IServiceProvider services, FoundationDPoPFeature feature)
{

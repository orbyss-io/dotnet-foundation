...
{
    var settings = new ShellSettings(new ShellId("probe"), ["Orbyss.Foundation.Authentication.DownstreamApi"]);
    ...
    new FoundationDownstreamApiFeature(settings).ConfigureServices(services);

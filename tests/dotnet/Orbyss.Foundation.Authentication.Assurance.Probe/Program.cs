...
{
    var settings = new ShellSettings(new ShellId("probe"), ["Orbyss.Foundation.Authentication.Assurance"]);
    ...
    new FoundationAssuranceFeature(settings).ConfigureServices(services);

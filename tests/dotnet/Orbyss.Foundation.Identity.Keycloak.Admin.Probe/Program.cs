...
var settings = new ShellSettings(new ShellId("probe"), ["Orbyss.Foundation.Identity.Keycloak.Admin.Users"]);
...
new FoundationKeycloakUsersAdminFeature(settings).ConfigureServices(services);
...
new FoundationKeycloakApplicationsAdminFeature(settings).ConfigureServices(services);
new FoundationKeycloakScopesAdminFeature(settings).ConfigureServices(services);
new FoundationKeycloakAccessAdminFeature(settings).ConfigureServices(services);
new FoundationKeycloakEnrollmentAdminFeature(settings).ConfigureServices(services);
new FoundationKeycloakSessionsAdminFeature(settings).ConfigureServices(services);
new FoundationKeycloakAuthenticationFlowsAdminFeature(settings).ConfigureServices(services);
new FoundationKeycloakIdentityProvidersAdminFeature(settings).ConfigureServices(services);
new FoundationKeycloakOrganizationsAdminFeature(settings).ConfigureServices(services);
new FoundationKeycloakRealmOperationsFeature(settings).ConfigureServices(services);

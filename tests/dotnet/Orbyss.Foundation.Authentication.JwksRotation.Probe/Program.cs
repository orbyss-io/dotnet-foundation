...
const string audience = "orbyss-foundation-api";
    ...
    string audience)
{
    var settings = new ShellSettings(
        new ShellId("probe"),
        ["Orbyss.Foundation.Authentication", "Orbyss.Foundation.Authentication.SpaPkce"]);
    settings.ConfigurationData[$"{FoundationWebOptions.SectionName}:Authority"] = issuer;
    settings.ConfigurationData[$"{FoundationWebOptions.SectionName}:ClientId"] = "orbyss-foundation-spa";
    settings.ConfigurationData[$"{FoundationWebOptions.SectionName}:Audience"] = audience;
    settings.ConfigurationData[$"{FoundationWebOptions.SectionName}:Scopes:0"] = "openid";
    settings.ConfigurationData[$"{FoundationWebOptions.SectionName}:AllowedOrigins:0"] = "https://app.example";
    ...
    new FoundationSpaPkceFeature().ConfigureServices(services);

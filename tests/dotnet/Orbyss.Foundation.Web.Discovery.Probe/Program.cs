...
var output = "web/generated/orbyss-foundation";
...
var settings = new ShellSettings(new ShellId("public"), ["Orbyss.Foundation.Web.Discovery"]);
var feature = new FoundationDiscoveryFeature(settings);
...
try
{
    ...
    foreach (var path in new[] { "/account", "/publication.json", "/integration/tokens.json", "/acceptance/gallery.html", "/.orbyss-foundation/ui/content.json" })
    {
